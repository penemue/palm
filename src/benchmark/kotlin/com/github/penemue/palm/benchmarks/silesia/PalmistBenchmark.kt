...
/**
 * Compression-ratio benchmark of the next-byte prediction compressor over the complete Silesia
 * Compression Corpus, measured and reported by [runSilesiaBenchmark].
 *
...
class PalmistBenchmark {
    ...
    @Test
    fun `prediction by several orders at once on Silesia Corpus`() =
        runSilesiaBenchmark("palmist")
}
